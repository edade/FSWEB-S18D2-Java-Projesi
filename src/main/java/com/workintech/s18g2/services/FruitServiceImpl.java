...
import com.workintech.s18g2.dao.FruitRepository;
...
public class FruitServiceImpl implements FruitService{
    ...
    public Fruit getById(long id) {
        ...
        return fruitOptional.orElseThrow(()-> new EntityException("the data with given id is not found", HttpStatus.NOT_FOUND));
    }
